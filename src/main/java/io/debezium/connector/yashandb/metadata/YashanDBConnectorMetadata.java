...
public class YashanDBConnectorMetadata implements ConnectorMetadata {

    @Override
    public ConnectorDescriptor getConnectorDescriptor() {
        return new ConnectorDescriptor("yashandb", "Debezium YashanDB Connector", YashanDBConnector.class.getName(), Module.version());
    }
